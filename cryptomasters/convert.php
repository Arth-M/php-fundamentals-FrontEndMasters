...
// require "./classes/converter.php"; //will trigger an error if the file is not imported
require_once "./classes/converter.php"; //same as include_once but throwing an error if the file cannot be loaded
?>
